...
from model import FusionModelconcat
...
# 创建模型实例
model = FusionModelconcat(in_features_1d=9924, in_features=60, out_features=128, in_features_3d=56, num_classes=4).to(device)
...
# 创建保存训练过程的文件路径
training_process_path = 'data/pic/1+2+3concat/training_process.txt'
...
# 保存路径
best_model_path = 'data/model_path/1D+2D+3Dconcat/best_model.pth'
